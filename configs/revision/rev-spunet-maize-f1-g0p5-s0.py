...
# rev-spunet-maize-f1-g0p5-s0: fold 1 (test ['Maize03', 'Maize04']), grid 0.5 mm, seed 0,
# corrected labels, evaluated with model_last.
"""SparseUNet (MinkUNet-style) semantic segmentation on Pheno4D maize (soil / stem / leaf).

Copy to: Pointcept/configs/pheno4d/semseg-spunet-pheno4d-maize.py
...
train_plants = ['Maize01', 'Maize02', 'Maize05', 'Maize06', 'Maize07']
test_plants  = ['Maize03', 'Maize04']
