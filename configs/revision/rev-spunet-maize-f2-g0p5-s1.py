...
# rev-spunet-maize-f2-g0p5-s1: fold 2 (test ['Maize05', 'Maize06']), grid 0.5 mm, seed 1,
...
train_plants = ['Maize01', 'Maize02', 'Maize03', 'Maize04', 'Maize07']
test_plants  = ['Maize05', 'Maize06']
