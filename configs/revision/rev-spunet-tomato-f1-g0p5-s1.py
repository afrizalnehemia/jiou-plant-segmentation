...
# rev-spunet-tomato-f1-g0p5-s1: fold 1 (test ['Tomato03', 'Tomato04']), grid 0.5 mm, seed 1,
...
train_plants = ['Tomato01', 'Tomato02', 'Tomato05', 'Tomato06', 'Tomato07']
test_plants  = ['Tomato03', 'Tomato04']
# ----------------------------------------------------------------- TOMATO NOTES
